...
describe('CorsService (Unit)', () => {
  ...
  beforeEach(() => {
    // Set valid CODING_AGENT_CORS_ORIGINS for tests
    process.env.CODING_AGENT_CORS_ORIGINS = 'http://localhost:3000,http://localhost:3001';
  });

  afterEach(() => {
    delete process.env.CODING_AGENT_CORS_ORIGINS;
  });

  describe('initialization', () => {
    it('should initialize with valid CODING_AGENT_CORS_ORIGINS', () => {
      // Act
    ...
    it('should throw error for invalid CODING_AGENT_CORS_ORIGINS format', () => {
      // Arrange
      console.log('→ Testing error state: Invalid CODING_AGENT_CORS_ORIGINS format');
      process.env.CODING_AGENT_CORS_ORIGINS = 'invalid-url-format';

      // Act & Assert
      expect(() => new CorsService()).toThrow('Invalid CODING_AGENT_CORS_ORIGINS');
    });
  });
  ...
  describe('refreshConfig', () => {
    beforeEach(() => {
      process.env.CODING_AGENT_CORS_ORIGINS = 'http://localhost:3000';
      service = new CorsService();
    });
    ...
    it('should reload configuration from environment', () => {
      ...
      process.env.CODING_AGENT_CORS_ORIGINS = 'http://localhost:4000';
